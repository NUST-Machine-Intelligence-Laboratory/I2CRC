...
def train(config_path, cuda):
    ...
    # Optimizer
    optimizer = torch.optim.SGD(model.module.base.optim_parameters(),
                          lr=CONFIG.SOLVER.LR, momentum=CONFIG.SOLVER.MOMENTUM, weight_decay=CONFIG.SOLVER.WEIGHT_DECAY)
